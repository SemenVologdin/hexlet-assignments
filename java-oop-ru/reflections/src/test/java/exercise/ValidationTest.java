...
class ValidationTest {
    ...
    void testAdvanceValidate() {
        ...
        Map<String, List<String>> expected1 = Map.of("city", List.of("length less than 10"));
        assertThat(result1).isEqualTo(expected1);
        ...
        Map<String, List<String>> expected2 = Map.of(
                ...
                "city", List.of("length less than 10")
        );
        assertThat(result2).isEqualTo(expected2);
        ...
        Map<String, List<String>> expected3 = Map.of(
                ...
                "city", List.of("can not be null", "length less than 10")
        );
        assertThat(result3).isEqualTo(expected3);
    }
    // END
